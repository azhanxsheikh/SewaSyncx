...
export type DispatchEvent =
  | { type: 'job-created'; job: DispatchJob }
  | { type: 'job-updated'; job: DispatchJob }
  | { type: 'NEW_REQUEST'; request: DispatchJob }
  | { type: 'ACCEPTED' | 'STATUS'; requestId: string; status: JobStatus; job?: DispatchJob };
