      ...
      <div className="relative min-h-0 flex-1">
        ...
        <div className="absolute top-16 left-4 right-4">
          <div className="max-w-md mx-auto bg-emerald-500 text-white px-4 py-3 rounded-2xl flex items-center gap-3 shadow-lg shadow-emerald-200 slide-up">
            ...
            <p className="text-sm font-600">Technician assigned! Rahul is on his way.</p>
          </div>
        </div>
            ...
            <div className="max-w-md mx-auto">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <h2 className="font-display font-800 text-xl text-gray-900">Rahul Kumar</h2>
                </div>
                <div className="text-right">
                  <div className="font-display font-800 text-3xl text-blue-600">{tech.eta}</div>
