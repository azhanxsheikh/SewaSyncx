    ...
    return (
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 px-4 pt-5 pb-24 max-w-md mx-auto w-full space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {serviceCategories.slice(0, 8).map((cat) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-500 text-gray-600 leading-tight">
                    {cat.name}
                  </span>
                </button>
              ))}
          ...
          {/* TODO: Phase 2 - notify family member */}
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-4">
          ...
          {error && (
            <p className="mt-2 text-sm font-600 text-red-600">{error}</p>
          )}
        </div>
      </div>
    )
          ...
          {familyMembers.map((m) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-14 h-14 rounded-full bg-${m.color}-100 flex items-center justify-center text-3xl`}
                >
                  {m.emoji}
                </div>
